    ...
    const loadUserDetails = async () => {
      try {
        ...
        if (result.success && result.details) {
          ...
          localStorage.setItem('authMethod', details.AuthMethod || 'email'); 
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 lg:p-10 space-y-6 bg-muted/20 dark:bg-muted/10">
        ...
        >
          <div className="flex items-center space-x-3 mb-6">
            <motion.div
              animate={{ rotate: [0, 5, -5, 0, 5, -5, 0], scale: [1, 1.05, 1] }}
          ...
          <motion.div variants={cardVariants}>
            <Card className="bg-card border border-border/30 rounded-xl shadow-lg">
              <CardHeader>
                <CardTitle className="text-lg md:text-xl font-semibold">Profile Information</CardTitle>
          ...
          <motion.div variants={cardVariants} className="mt-6 md:mt-8">
            <div className={cn(authMethod !== 'email' ? "opacity-60 pointer-events-none" : "")}>
              <Card className="bg-card border border-border/30 rounded-xl shadow-lg">
                <CardHeader>
                  <CardTitle className="text-lg md:text-xl font-semibold">Security</CardTitle>
                  <CardDescription>
                    {authMethod !== 'email' 
           ...
           <motion.div variants={cardVariants} className="mt-6 md:mt-8">
            <Card className="bg-card border border-border/30 rounded-xl shadow-lg">
              <CardHeader>
                <CardTitle className="text-lg md:text-xl font-semibold">Session Management</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <motion.div variants={cardVariants} className="mt-6 md:mt-8 mb-8">
            <Card className="bg-card border-destructive/50 rounded-xl shadow-lg">
              <CardHeader>
                <CardTitle className="text-lg md:text-xl font-semibold text-destructive">Danger Zone</CardTitle>
              </CardHeader>
              <CardContent>
