    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col items-center justify-center text-center">
        <motion.div
          ...
          className="max-w-2xl w-full bg-card p-8 sm:p-10 md:p-12 rounded-xl shadow-xl border border-border/30"
        >
          <div className="mb-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-foreground leading-tight">
              ...
              <span className="inline-block mx-2 px-2 py-1 border-2 border-foreground rounded-lg">
                page
              </span>
            </h1>
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-emerald-500 hover:bg-emerald-600 text-white font-semibold text-base px-8 py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
            >
              <Link href="/">
